    ...
    if (paralax) {
        ...
        function parallaxFunc(scrollTopProcent, scrollTopProcentOpacity) {
            ...
            if (scrollTopProcent>=1.0){
                ...
                house.parentElement.style.cssText = `filter: blur(${1/scrollTopProcentOpacity}px); opacity: ${scrollTopProcentOpacity}; z-index: 2; display: block;`;
                up.parentElement.style.cssText = `filter: blur(${1/scrollTopProcentOpacity}px); opacity: ${scrollTopProcentOpacity}; z-index: 0; display: block;`;
                down.parentElement.style.cssText = `filter: blur(${1/scrollTopProcentOpacity}px); opacity: ${scrollTopProcentOpacity}; z-index: 3; display: block;`;
        ...
        function init(){
            width = document.querySelector('.slider_body').offsetWidth;
